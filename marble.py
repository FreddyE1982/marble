...
class MARBLE:
    ...
    def __init__(
        ...
        self.neuronenblitz = Neuronenblitz(
            ...
            continue_decay_rate=nb_defaults["continue_decay_rate"],
            struct_weight_multiplier1=nb_defaults["struct_weight_multiplier1"],
            struct_weight_multiplier2=nb_defaults["struct_weight_multiplier2"],
            attention_decay=nb_defaults["attention_decay"],
            max_wander_depth=nb_defaults["max_wander_depth"],
            learning_rate=nb_defaults["learning_rate"],
            weight_decay=nb_defaults["weight_decay"],
            dropout_probability=nb_defaults["dropout_probability"],
            dropout_decay_rate=nb_defaults["dropout_decay_rate"],
            exploration_decay=nb_defaults["exploration_decay"],
            reward_scale=nb_defaults["reward_scale"],
            stress_scale=nb_defaults["stress_scale"],
            auto_update=nb_defaults["auto_update"],
            remote_fallback=nb_defaults["remote_fallback"],
            noise_injection_std=nb_defaults["noise_injection_std"],
            dynamic_attention_enabled=nb_defaults["dynamic_attention_enabled"],
